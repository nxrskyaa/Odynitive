...
const releases = [
  { date: '02 AUG 2026', version: 'V0.3', titleId: 'Information architecture baru', titleEn: 'New information architecture', bodyId: 'Branding disederhanakan menjadi Odynitive. Navigasi Docs, About, Updates, dan Actions ditambahkan; Odyvion masuk ke product lineup sebagai realm GameFi. NFT Marketplace dan Agentz kini memiliki concept preview dengan status pengembangan yang jelas.', bodyEn: 'Branding is now simply Odynitive. Docs, About, Updates, and Actions navigation were added; Odyvion joined the product lineup as the GameFi realm. NFT Marketplace and Agentz now have concept previews with explicit development status.' },
